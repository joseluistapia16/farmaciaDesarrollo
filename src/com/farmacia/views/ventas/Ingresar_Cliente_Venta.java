...
import com.farmacia.views.clientes.*;
...
public class Ingresar_Cliente_Venta extends javax.swing.JDialog {
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ingresar_Cliente_Venta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Ingresar_Cliente_Venta dialog = new Ingresar_Cliente_Venta(new javax.swing.JFrame(), true);
