 ...
 * @author guest-qzjm76
 */
public class AgregarProductoEditarNotaPedido1 extends javax.swing.JDialog {

    int x, y;
    joinProductoDetallesFaltantes objf = new joinProductoDetallesFaltantes();
    Validacion v = new Validacion();

    public AgregarProductoEditarNotaPedido1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public AgregarProductoEditarNotaPedido1(java.awt.Frame parent, boolean modal, joinProductoDetallesFaltantes obj1) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        this.setLocationRelativeTo(null);
...
//            JOptionPane.showMessageDialog(null, "INGRESE NUMEROS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarProductoEditarNotaPedido1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarProductoEditarNotaPedido1 dialog = new AgregarProductoEditarNotaPedido1(new javax.swing.JFrame(), true);
