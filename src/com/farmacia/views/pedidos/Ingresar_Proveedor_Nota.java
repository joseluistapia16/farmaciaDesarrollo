...
import com.farmacia.views.proveedor.*;
...
public class Ingresar_Proveedor_Nota extends javax.swing.JDialog {
    ...
    public Ingresar_Proveedor_Nota(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ingresar_Proveedor_Nota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Ingresar_Proveedor_Nota dialog = new Ingresar_Proveedor_Nota(new javax.swing.JFrame(), true);
